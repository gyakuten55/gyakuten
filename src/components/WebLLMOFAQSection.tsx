...
const faqs: FAQ[] = [
  {
    ...
    answer: "構造化データマークアップ、FAQ形式のコンテンツ設計、E-E-A-T（経験・専門性・権威性・信頼性）に基づく情報設計を行います。これにより、Perplexity AIやChatGPT Search、Google GeminiなどのAI検索エンジンがサイトを「発見し・要約し・引用しやすい」構造に最適化します。"
  },
  {
  ...
  },
  {
    ...
    answer: "①最新AI検索に特化した構造化設計、②業界最安値レベルの明確料金、③LLM・LLMO・SEOの専門知識を持つスタッフによる一気通貫サポート、④ヒアリングから実装、その後のサポートまで同じスタッフが担当する継続性が主な差別化ポイントです。"
  },
  {
  ...
  },
  {
    ...
    answer: "はい、既存サイトのLLMO対応リニューアルも承っております。現在のサイトの良い部分を活かしながら、最新AI検索時代に対応した構造に最適化いたします。まずは無料相談でご相談ください。"
  }
];
