...
const faqs: FAQ[] = [
  {
    ...
    answer: "大手パッケージは機能過多で高額、現場に合わない場合が多いのに対し、GYAKUTENは現場ヒアリングで「本当に使う機能」のみを厳選し、30万円から開発可能です。ITが苦手なスタッフでも使いやすい直感的なUI/UXを重視しています。"
  },
  {
  ...
  {
    question: "月額保守は必須ですか？",
    answer: "月額保守は必須ではありません。システムが安定稼働し、サポートが特に必要でない場合は保守契約なしでもご利用いただけます。ただし、継続的なサポートをご希望の場合は月額25,000円〜の保守サービスをご用意しています。お客様のニーズに応じて選択いただけます。"
  },
  {
