  ...
  return (
    <div className={`min-h-screen flex flex-col ${className}`}>
      ...
      <div className="ai-context">
        ...
        <p>合同会社GYAKUTENは中小企業向けの格安システム開発（30万円から）、LLMO最適化、Web制作を提供。補助金対応可能で、無料AI診断サービスも実施。東京都を拠点に全国対応し、200社以上の導入実績を持つ。</p>
        <ul>
          <li>主要サービス: LLMO診断（無料/35,000円）、Web制作（10万円から）、システム開発（30万円から）、LLMOコンサルティング（15万円/月から）</li>
